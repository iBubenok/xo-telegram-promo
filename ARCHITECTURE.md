...
- ИИ: два режима. «Уверенная» — minimax (победа ИИ = 10 - глубина, победа игрока = глубина - 10, ничья = 0). «Лёгкая» — случайный ход из доступных, даёт пользователю шанс выиграть. Задержка перед ходом ~280/380 мс для плавности.
